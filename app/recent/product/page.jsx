        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <p className="text-sm text-justify sm:text-start font-sans py-4 leading-6 text-gray-700">
              ...
              ceilings, 4 Beds (all with private baths) and a laundry room.
              Master Bed comes with his/her sinks, soaker tub, custom shower
              with body jets. Open concept main floor is an entertainer&apos;s
              paradise with a 10&apos; ceiling, glass stairs, security surveillance,
              speaker system, engineered hardwood flooring, radiant heating,
              A/C, HRV & built-in vacuum. Fisher & Paykel appliances in the
              kitchen. Large sized WOK kitchen. Mudroom with extra storage for
              added convenience. Flex room on the main floor has a full bath.
              Fenced yard & large covered patio great for BBQs. 2 BDRM Legal
              suite, potential second 2 BDRM suite, media room with full bath
              and separate entry & 600 square ft detached garage with bath.
            </p>
